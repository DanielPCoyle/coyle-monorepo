  ...
  return (
    <li key={admin.id} className="adminItem" data-testid={`admin-item-${admin.id}`}>
      ...
      <div className="adminDetails" data-testid={`admin-details-${admin.id}`}>
        ...
        <small data-testid={`admin-email-${admin.id}`}>{admin.email}</small>
      </div>
