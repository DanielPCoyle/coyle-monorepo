...
export function HomeScreen() {
  ...
  return (<>
    {
      view === "home" && <View style={styles.container}>
        {/* <Image source={require('./path/to/logo.png')} style={styles.logo} /> */}
        <Text style={styles.title}>Welcome to Chat App</Text>
        <TouchableOpacity onPress={()=>setView("login")} style={styles.button}>
    ...
    }
    {
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput style={styles.input} placeholder="Enter website" value={website} onChangeText={handleWebsiteChange} />
      </View>
      ...
      <TouchableOpacity onPress={()=>setView("home")} style={styles.backLink} >
          <Text>back</Text>
      </TouchableOpacity>
      </View>
      </>
