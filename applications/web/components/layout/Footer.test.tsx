...
describe('Footer', () => {
  it('renders company name', () => {
    render(<Footer />);
    expect(screen.getByText('Philadelphia Screen Printing')).toBeInTheDocument();
  });
  ...
  it('renders social media icons with correct links', () => {
    ...
    const twitter = links.find((link) =>
      link.getAttribute('href') === 'https://twitter.com/yourtwitter'
    );
    const facebook = links.find((link) =>
