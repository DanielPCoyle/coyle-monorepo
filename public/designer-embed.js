(function () {
  ...
  function launchEmbeddedDesignStudio(params) {
    ...
    let url =
      params.url ||
      urlBase +
        (params.productId ? productUrl : "/shop/design-studio/select-product");
    ...
    let iframe = createFrame(
      url,
      "designStudioIframe",
      "InkSoft Embedded Design Studio",
    );
    ...
    loadScript(
      (params.domain ? params.domain : "") +
        (params.storeUri ? "/FrontendApps/storefront" : "") +
        "/assets/scripts/post-robot.js",
      "post-robot",
      function () {
